...
$bloat0 = "*3dbuilder*","*windowsalarms*","*windowscalculator*","*windowscommunicationsapps*","*windowscamera*","*officehub*","*skypeapp*"
$bloat1 = "*getstarted*","*zunemusic*","*windowsmaps*","*solitairecollection*","*bingfinance*","*zunevideo*","*bingnews*","*onenote*"
$bloat2 = "*people*","*phone*","*photos*","*windowsstore*","*bingsports*","*soundrecorder*","*bingweather*","*xboxapp*"
